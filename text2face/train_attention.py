...
encoder = Encoder(embedding_dim, input_dim, out_channels, kernel_size, decoder_hidden_dim)
attention = Attention(encoder_dim, decoder_hidden_dim)
decoder = Decoder(attention, encoder_dim, decoder_hidden_dim, image_dim)
